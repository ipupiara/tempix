...
#define OS_TMR_CFG_TICKS_PER_SEC 20u  /*     Rate at which timer management task runs (Hz)            */
// pn 21Feb2021: must be dividable by 5 for tempix application
...
#define HzTimeout				  OS_TMR_CFG_TICKS_PER_SEC
#define OSTimeoutMS(amtMS)        ((amtMS *  HzTimeout) / 1000)
